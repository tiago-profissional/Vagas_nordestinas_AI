  ...
  return (
    ...
    <>
              ...
              <div className="flex w-full flex-col items-center justify-center gap-6 @[420px]:flex-row @[420px]:gap-10">
                ...
                <div className="relative flex h-[130px] w-[130px] shrink-0 items-center justify-center rounded-full border-[9px] border-yellow-400 @[420px]:h-[160px] @[420px]:w-[160px] @[420px]:border-[12px]">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[17px] text-gray-500 @[420px]:text-[24px]">
                ...
                <div className="max-w-[280px] text-center @[420px]:text-left">
                  ...
                  <button
                    ...
                    className="mt-4 text-sm font-semibold text-yellow-600 transition hover:text-yellow-700 hover:underline"
      ...
      <Modal
        ...
        title="Como sua pontuação foi calculada"
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-gray-600">
              ...
              <li>• Estrutura e organização do currículo</li>



              <li>• Clareza das experiências profissionais</li>



              <li>• Quantidade e relevância das skills</li>



              <li>• Uso de palavras-chave técnicas</li>



              <li>• Resultados e conquistas apresentados</li>



              <li>• Consistência das datas e informações</li>
          ...
          <section>
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">
              ...
              Adicione resultados mensuráveis às experiências, revise datas,



              destaque tecnologias relevantes e adapte o currículo para cada
